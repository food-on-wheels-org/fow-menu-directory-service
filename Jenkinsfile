    ...
    stages {
        ...
        stage('Code Coverage') {
            steps{
                script{
                    ...
                    def componentKey = "com.project.tejas:menuItem"
        ...
        stage('Docker Build and Push') {
            steps {
                ...
                sh 'docker build -t tejassrivathsa/menu-directory-service:${VERSION} .'
                sh 'docker push tejassrivathsa/menu-directory-service:${VERSION}'
            }
        }
        ...
        stage('Update Image tag in GitOps') {
            steps {
                ...
                script {
                       sh '''
                          sed -i "s/image:.*/image: tejassrivathsa\\/menu-directory-service:${VERSION}/" k8s/apps/menu-directory-manifest.yml
                        '''
